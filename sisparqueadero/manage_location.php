...
<div class="container-fluid">
	<form action="" id="manage-location">
		...
		<div class="form-group">
			<label for="" class="control-label">Categoria de vehículo</label>
		...
		<div class="form-group">
			<label for="" class="control-label">Ubicación del área</label>
			<input type="text" class="form-control" name="location"  value="<?php echo isset($location) ? $location :'' ?>" required>
		</div>
		<div class="form-group">
			<label for="" class="control-label">Capacidad de área</label>
