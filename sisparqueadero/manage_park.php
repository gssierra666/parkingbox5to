...
<div class="container-fluid mt-4">
    <div class="card" style="border: 1px solid white;">
	    <div class="card-header text-white" style="background-color: #4c9f3f;">
			<span><b><?php echo isset($id) ? "Editar" : "Nuevo" ?> Vehículo</b></span>
		</div>
		<div class="card-body">
			<form action="" id="manage-vehicle"> 
				...
				<div class="col-lg-12">
					...
					<div class="row form-group">
						...
						<div class="col-md-5">
							<label for="" class="control-label">N° placa del vehículo</label>
					...
					<div class="row form-group">
						<div class="col-md-5">
							<label for="" class="control-label">Nombre del dueño</label>
